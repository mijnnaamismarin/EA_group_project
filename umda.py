...
def sample_new_population(probabilities, gene_values_list, population_size, feature_intervals, generation, total_generations):
...
for generation in range(num_generations):
    ...
    new_population = sample_new_population(probabilities, gene_values, population_size, feature_intervals, generation, num_generations)
